...
%		\draw[opacity = 0.3] (A) -- (B) node[anchor = north] {\scriptsize{$L$}};
		\draw[opacity = 0.3] (A') -- (B') node[anchor = north] {\scriptsize{$L_1$}};
...
%	\filldraw[opacity = 0.3] (P) circle (1pt) node[below] {\scriptsize{$P$}};	
	\filldraw[opacity = 0.3] (P') circle (1pt) node[below] {\scriptsize{$P_1$}};	
	\filldraw[opacity = 1]   (P'') circle (1pt) node[below] {\scriptsize{$P_2$}};				
%			\node at (A) { $A$};
%			\node at (A') { $A'$};	
%			\node at (A'') { $A''$};
