...
\filldraw (P) node[anchor = -20, outer sep = 0pt] {$P(a,b,c)$}  circle (1pt);
...
% XY plane
\draw[ultra thin] (P) -- (Pxy) -- (Px) node[anchor=180] {$a$} ;
\draw[ultra thin] (P) -- (Pxy) -- (Py);

% XZ plane
\draw[dashed, ultra thin] (Pxz) -- (Pz) node[anchor=180] {$c$} ;
%\draw[dashed, ultra thin] (P) -- (Pxz) -- (Px);
%\draw[ultra thin] (P) -- (Pxz);

% YZ plane
\draw[dashed, ultra thin] (P) -- (Pyz) -- (Py) node[anchor=90] {$b$};
...
\draw[black] ($(Px)!0.5!(P)$) to[out=90, in=230] (2.5,2.2,2) node[anchor = 270] {\scriptsize{$\sqrt{b^2+c^2}$}};


\draw[black] (\Px,0,\Pz+.5) to[out=180, in=0] (\Px+.5,.2,\Pz+.5) node[anchor = 0] {\scriptsize{$\sqrt{b^2+c^2}$}};
...
\tdplotdrawarc[tdplot_rotated_coords, orange, dashed]{(0,0,0)}{4.03}{180}{268}{anchor = 310}{}

\tdplotdrawarc[tdplot_rotated_coords, orange, dashed]{(0,0,0)}{4.03}{410}{480}{anchor = 310}{}
