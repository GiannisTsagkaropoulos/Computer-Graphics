...
% Nodes
	...
	\node[anchor=190] at (Pproj') {$\sqrt{b^2+c^2}$};	
...
% Radius
	...
	\draw[green!10!purple, thick] (O) -- node[midway, anchor=30] {$\rho$} (Pproj) ;	

	\draw[green!10!purple, thick] (O) -- node[midway, anchor=180] {$\rho$} (Pproj'') ;	
% Orange
...
\tdplotdrawarc[tdplot_rotated_coords, -latex, black]{(0,0,0)}{0.6}{144.5}{180}{anchor=280}{$\theta_2$} 

\path[tdplot_rotated_coords,fill=green!10!purple,fill opacity=0.4] (0,0,0) -- plot[variable=\t, domain=-54:-90] (xyz spherical cs:radius=0.6,longitude=\t,latitude=0) -- cycle; 
