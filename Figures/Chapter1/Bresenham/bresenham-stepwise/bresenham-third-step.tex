...
%		%Grid
		...
		\node at (0.5,0) [below] {\scriptsize{$x_{i-2}$}};
		\node at (0,0.5) [left] {\scriptsize{$y_{i-2}$}};
		
		\node at (1.5,0) [below] {\scriptsize{$x_{i-1}$}};
		\node at (0,1.5) [left] {\scriptsize{$y_i, y_{i-1}$}};
		
		\node at (2.5,0) [below] {\scriptsize{$x_{i}$}};
	
		\node at (3.5,0) [below] {\scriptsize{$x_{i+1}$}};
%		\node at (0,3.5) [left] {\scriptsize{$y_{i+1}$}};
...
\draw[dashed] (intersection) -- ($(0,0)!(intersection)!(0,1)$) node[left] {\scriptsize{$y_{i+1}, y$}};
...
\fill[green!50!blue, opacity=0.1] (3,1) rectangle (4,3) ;

\draw[black, very thin] (3,2) -- (4,2); 
